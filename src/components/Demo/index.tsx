		...
		<>
			...
			>
				...
				<SectionHeader
					...
					headerInfo={{
						title: "DEMO",
						subtitle: "TinyGen in Action",
						description:
							"Give TinyGen a try and see how it can help you. This is just a simplified demo, there's a lot more you can do with TinyGen!",
					}}
				/>
				{/* <!-- Section Title End --> */}
				<div
				...
				>
						...
						<div className="controls">
							...
							<div className="duration-container">
								...
								<div className="total-time">
									{getTimeFromSeconds(totalTime)}
								</div>
							</div>
							{/* <SnipBtn videoRef={videoRef} className="" /> */}
					...
					<video ref={videoRef} src="demo-yt/demo-video.webm">
						<track kind="captions" srcLang="en" src="demo-yt/subtitles.vtt" />
					</video>
				</div>
				<style jsx>{`
          .video-container {
